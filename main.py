...
# Este método se encarga de la inserción de datos necesaria para que se ejecute el método consulta_parametrizada de la clase controlador.py de forma adecuada. Además muestra al usuario
